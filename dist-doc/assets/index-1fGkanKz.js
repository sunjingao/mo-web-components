import { C as u } from './vue-BWiB27ne.js';
import {
  f as g,
  g as d,
  h as v,
...
/* empty css                                                            */ const D = g({
    __name: 'index.md.Virtualf1ac39f1',
    setup(j) {
      const c = [
          {
            value: 'zhongwen',
            ...
            children: [
              {
                ...
                label: '中文1',
                children: [
                  { value: 'zhongwen11', label: '中文11' },
                  { value: 'zhongwen111', label: '中文111' }
                ]
              }
            ]
          },
            ...
            children: [
              {
                value: 'yingwen1',
                label: '英文1',
                children: [{ value: 'yingwen11', label: '英文11' }]
              }
            ]
          }
        ],
          ...
          return (
            ...
            o('div', null, [
              n(
                ...
                {
                  value: l.value,
                  'onUpdate:value': t[0] || (t[0] = (p) => (l.value = p)),
                  options: c,
  ...
  b = g({
    __name: 'index.md.Virtual767ab1d9',
    setup(j) {
      const c = [
          {
            value: 'zhejiang',
            ...
            children: [
              {
                ...
                label: '中文1',
                children: [
                  { value: 'xihu', label: '中文11' },
                  { value: 'xihu2', label: '中文111' }
                ]
              }
            ]
          },
            ...
            children: [
              {
                value: 'nanjing',
                label: '英文1',
                children: [{ value: 'zhonghuamen', label: '英文11' }]
              }
            ]
          }
        ],
  ...
  _ = g({
    __name: 'index.md.Virtuala42e6c10',
    setup(j) {
      const c = [
          {
            value: 'zhejiang',
            ...
            o('div', null, [
              n(
                r,
                {
                  ...
                  multiple: '',
                  placeholder: 'Please select',
                  'show-checked-strategy': i(m).SHOW_CHILD
                },
                null,
                8,
  ...
  E = { class: 'marked-body' },
  w = a('h2', { id: 'cascader' }, 'Cascader', -1),
  f = a('h3', { id: '搜索功能' }, '搜索功能', -1),
  y = a('ul', null, [a('li', null, '默认开启搜索功能')], -1),
  z = a(
    'pre',
    { class: 'language-xml' },
    [
...
`),
  ...
  `),
    ...
    `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-cascader'),
          s(`
      `),
          a('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"value"'),
          s(`
      `),
          a('span', { class: 'hljs-attr' }, ':options'),
          s('='),
          a('span', { class: 'hljs-string' }, '"options"'),
          s(`
      `),
          a('span', { class: 'hljs-attr' }, 'placeholder'),
          s('='),
          a('span', { class: 'hljs-string' }, '"Please select"'),
          s(`
    />`)
        ]),
        s(`
  ...
  `),
          ...
          s(` options = [
    {
      `),
          ...
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhongwen'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'中文'"),
          s(`,
      `),
          ...
          s(`: [
        {
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhongwen1'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'中文1'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'children'),
          s(`: [
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhongwen11'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'中文11'"),
          s(`,
            },
            {
              `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhongwen111'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'中文111'"),
          s(`,
            },
          ],
        },
    ...
    },
    {
      `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'yingwen'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'英文'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'children'),
          s(`: [
        {
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'yingwen1'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'英文1'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'children'),
          s(`: [
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'yingwen11'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'英文11'"),
          s(`,
            },
          ],
        },
...
`)
  ...
  k = a(
    ...
    null,
    [
      a('li', null, '多选时，自动开启全选功能'),
      a('li', null, '未开启show-checked-strategy=Cascader.SHOW_CHILD时')
    ],
    -1
  ),
  F = a(
          ...
          s(` options = [
    {
      ...
      `),
          ...
          s(`: [
        {
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'xihu2'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
...
`)
  ...
  H = a(
    ...
    [
      a('li', null, '多选时，自动开启全选功能'),
      a('li', null, '开启show-checked-strategy=Cascader.SHOW_CHILD时')
    ],
    -1
  ),
  S = a(
  ...
  `),
    ...
    `),
      ...
      `),
          ...
          s(`
      `),
          a('span', { class: 'hljs-attr' }, ':show-checked-strategy'),
          s('='),
          a('span', { class: 'hljs-string' }, '"Cascader.SHOW_CHILD"'),
          s(`
    />`)
        ]),
        s(`
...
`),
  ...
  `),
          a('span', { class: 'hljs-keyword' }, 'import'),
          s(' { '),
          a('span', { class: 'hljs-title class_' }, 'Cascader'),
          s(' } '),
          a('span', { class: 'hljs-keyword' }, 'from'),
          s(),
          a('span', { class: 'hljs-string' }, "'ant-design-vue'"),
          s(`;
...
`)
  ...
  V = B(
    '<h3 id="props">Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>可选值或函数参数</th><th>默认值</th><th>是否必填</th></tr></thead><tbody><tr><td>enableSelectAll</td><td>多选时，是否开启全选</td><td>Boolean</td><td>-</td><td>true</td><td>否</td></tr></tbody></table>',
    2
  ),
  W = {
    __name: 'index',

import { C as j } from './vue-BWiB27ne.js';
import {
  f as g,
  g as e,
  o as i,
...
/* empty css                                                            */ const _ = g({
    __name: 'index.md.Virtual19bbb8ed',
    setup(A) {
      const r = e([
        ...
        d = e([{ name: '胡彦斌', age: 32, address: '西湖区湖底公园1号' }]);
      return (n, l) => {
        const p = h('m-table');
        return (
          i(), E(p, { columns: r.value, dataSource: d.value }, null, 8, ['columns', 'dataSource'])
        );
      };
    }
  }),
  x = g({
    __name: 'index.md.Virtuald2d51ec2',
    setup(A) {
      const r = e([
          { title: '姓名', dataIndex: 'name', width: 200 },
          { title: '年龄', dataIndex: 'age', width: 200 },
        ...
        d = e([{ name: '赵', age: 1, address: '西湖区湖底公园1号' }]),
        n = e({
          items: [
            {
              label: '驳驳',
              isShowModal: !0,
              async confirmAsync(l) {
                console.log('驳驳 onclick', l);
              }
            },
            {
              label: '通过',
              ...
              async confirmAsync(l) {
                console.log('通过 onclick', l);
              }
            },
            {
              label: '拒绝',
              async confirmAsync(l) {
                console.log('拒绝 onclick', l);
              }
            },
            {
              label: '驳回驳回驳回',
              async confirmAsync(l) {
                console.log('驳回驳回驳回 onclick', l);
              }
            }
          ]
        });
      return (l, p) => {
        ...
        return (
          i(),
          E(o, { columns: r.value, dataSource: d.value, operationsColumn: n.value }, null, 8, [
            'columns',
            'dataSource',
            'operationsColumn'
          ])
  ...
  k = g({
    __name: 'index.md.Virtual3d31a93f',
    setup(A) {
      const r = e([
          { title: '姓名', dataIndex: 'name', width: 200 },
          { title: '年龄', dataIndex: 'age', width: 200 },
        ...
        d = e([
          { name: '赵', age: 1, address: '西湖区湖底公园1号' },
          { name: '钱', age: 2, address: '西湖区湖底公园2号' },
          { name: '孙', age: 3, address: '西湖区湖底公园3号' }
        ]),
        n = e({
          items: [
            {
              label: '驳驳',
              async confirmAsync(l) {
                console.log('驳驳 confirmAsync', l);
              },
              getHidden(l) {
                return console.log('驳驳 getHidden', l), l.age === 1;
              },
              getDisabled(l) {
                return console.log('驳驳 getDisabled', l), !1;
              }
            },
            {
              label: '通过',
              ...
              getHidden(l) {
                return console.log('通过 getHidden', l), !1;
              },
              getDisabled(l) {
                return console.log('通过 getDisabled', l), l.age === 2;
              }
            },
            {
              label: '拒绝',
              ...
              getHidden(l) {
                return console.log('拒绝 getHidden', l), !1;
              },
              getDisabled(l) {
                return console.log('拒绝 getDisabled', l), !1;
              }
            }
          ]
        });
  ...
  F = g({
    __name: 'index.md.Virtualbcfb0478',
    setup(A) {
      const r = e([
          { title: '姓名', dataIndex: 'name', width: 200 },
          { title: '年龄', dataIndex: 'age', width: 200 },
        ...
        d = e([
          { name: '赵', age: 1, address: '西湖区湖底公园1号' },
          { name: '钱', age: 2, address: '西湖区湖底公园1号' },
          { name: '孙', age: 3, address: '西湖区湖底公园1号' }
        ]),
        n = e({
          visible: !0,
          items: [
            {
              label: '操作',
              async confirmAsync() {
                return console.log('multiple', arguments), Promise.resolve();
              }
            }
          ]
        });
      ...
      return (o, B) => {
        ...
        return (
          i(),
          m('div', null, [
            t(C, { onClick: l, class: 'mb-8px' }, { default: c(() => [s('开启多选')]), _: 1 }),
            t(
              b,
              { columns: r.value, dataSource: d.value, multiple: n.value, onCancelMultiple: p },
              null,
              8,
              ['columns', 'dataSource', 'multiple']
            )
          ])
        );
      };
  ...
  v = g({
    __name: 'index.md.Virtual005c6f4f',
    setup(A) {
      const r = e([
          { title: '姓名', dataIndex: 'name', width: 200 },
          { title: '年龄', dataIndex: 'age', width: 200 },
  ...
  V = g({
    __name: 'index.md.Virtual02d5fd8d',
    setup(A) {
      const r = e([
          { title: '姓名', dataIndex: 'name', width: 200 },
          { title: '年龄', dataIndex: 'age', width: 200 },
        ...
        d = e([
          ...
          { name: '钱', age: 2, address: '西湖区湖底公园1号' },
          { name: '孙', age: 3, address: '西湖区湖底公园1号' },
          { name: '李', age: 4, address: '西湖区湖底公园1号' }
        ]),
        n = e({ currentMap: 2, sizeMap: 20, totalElements: 1e3, currentFromNumber: 0 }),
        l = e({
          current: 'currentMap',
          pageSize: 'sizeMap',
          total: 'totalElements',
          ...
          m('div', null, [
            t(
              B,
              {
                ...
                dataSource: d.value,
                pagination: n.value,
                paginationMap: l.value
              },
              null,
              8,
              ['columns', 'dataSource', 'pagination', 'paginationMap']
            )
          ])
        );
      };
  ...
  I = g({
    __name: 'index.md.Virtual18196185',
    setup(A) {
      const r = e([
          {
            title: '姓名',
          ...
          { title: '能源类型', dataIndex: 'energyName' }
        ]),
        d = e([
          {
            name: '赵',
      ...
      return (n, l) => {
        ...
        return (
          i(),
          m('div', null, [
            t(p, { dataSource: d.value, columns: r.value }, null, 8, ['dataSource', 'columns'])
          ])
        );
      };
    }
  ...
  S = g({
    __name: 'index.md.Virtual67469adf',
    setup(A) {
      const r = e([
          {
            title: '姓名',
          ...
          },
          {
            ...
            typeConfig: {
              type: 'copy',
              getEnable(n) {
                return console.log('getEnable', n), !0;
              }
            }
          },
          {
          ...
          },
          {
            ...
            typeConfig: {
              ...
              getLeftLabel(n) {
                return console.log(n), '下架';
              },
              getRightLabel(n) {
                return console.log(n), '上架';
              },
              getTitle(n) {
                return console.log(n), '确定操作switch？';
              },
              getContent(n) {
                return console.log(n), '内容展示';
              },
              confirmAsync(n) {
                return console.log('onOk', n), Promise.resolve();
              }
            }
          },
          {
          ...
          },
          {
            ...
            typeConfig: {
              type: 'previewDownload',
              getEnablePreview: function (n) {
                return n.index === 0 ? !0 : n.index === 1 ? !1 : (n.index === 2, !0);
              },
              getEnableDownload: function (n) {
                return n.index === 0 || n.index === 1 ? !0 : n.index !== 2;
              },
              getUrl(n) {
                return n.index === 0
                  ? 'https://www.runoob.com/wp-content/themes/runoob/assets/img/runoob-logo.png'
                  : n.index === 1
                    ? 'https://www.runoob.com/try/demo_source/horse.ogg'
                    : n.index === 2
                      ? 'https://www.runoob.com/try/demo_source/movie.mp4'
                      : n.index === 3
                        ? 'https://static.jyshare.com/download/sites.xlsx'
  ...
  M = { key: 0, class: 'color-red' },
  N = a('span', { class: 'color-red' }, '插槽', -1),
  T = g({
    __name: 'index.md.Virtual4d14c894',
    setup(A) {
      const r = e([
          {
            title: '姓名',
            ...
            filterSearch: !0,
            onFilter: (n, l) => l.name.includes(n)
          },
          {
            title: '年龄',
            width: 200,
            children: [
              { title: '年龄1', dataIndex: 'age1', width: 100 },
              { title: '年龄2', dataIndex: 'age2', width: 100 }
            ]
          },
          { title: '住址', dataIndex: 'address', sorter: (n, l) => n.age - l.age }
        ]),
        d = e([
          {
            name: '赵山河',
          ...
          { name: '赵山海', address: '西湖区湖底公园2号', age1: 33, age2: 34 },
          { name: '赵铁柱', address: '西湖区湖底公园4号', age1: 35, age2: 36 },
          { name: '赵小蛮', address: '西湖区湖底公园3号', age1: 37, age2: 38 }
        ]);
      return (n, l) => {
        const p = h('m-table');
        return (
          ...
          E(
            p,
            { columns: r.value, dataSource: d.value },
            {
              headerCell: c(({ column: o, text: B }) => [
                o.dataIndex === 'name' ? (i(), m('span', M, ' 插槽展示 ' + f(B), 1)) : D('', !0)
              ]),
              bodyCell: c(({ column: o, text: B }) => [
                o.dataIndex === 'age1' ? (i(), m(y, { key: 0 }, [N, s(f(B), 1)], 64)) : D('', !0)
              ]),
              _: 1
            },
            8,
  ...
  H = { class: 'marked-body' },
  O = a('h2', { id: 'table' }, 'Table', -1),
  P = a('h3', { id: '简单使用' }, '简单使用', -1),
  L = a(
    'ul',
    null,
    [
      a('li', null, 'table表头有吸顶效果'),
      a(
        'li',
        null,
  ...
  `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-table'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':columns'),
          s('='),
          a('span', { class: 'hljs-string' }, '"columns"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':dataSource'),
          s('='),
          a('span', { class: 'hljs-string' }, '"dataSource"'),
          s(` 
    >`)
        ]),
        s(`
...
`),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'年龄'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'age'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
...
`),
          ...
          s(': '),
          a('span', { class: 'hljs-string' }, "'胡彦斌'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age'),
          s(': '),
          a('span', { class: 'hljs-number' }, '32'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'西湖区湖底公园1号'"),
          s(`,
          },
        ]
)
...
`)
  ...
  z = a(
    ...
    null,
    [
      a('li', null, '最多展示两条，超过的内容会在下拉中展示'),
      a('li', null, '支持隐藏和禁止操作功能')
    ],
    -1
  ),
  U = a('h4', { id: '操作列精简配置' }, '操作列精简配置', -1),
  J = a(
    'pre',
    { class: 'language-xml' },
    [
  ...
  `),
        ...
        `),
          ...
          s(` 
        `),
          a('span', { class: 'hljs-attr' }, ':operationsColumn'),
          s('='),
          a('span', { class: 'hljs-string' }, '"operationsColumn"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
  ...
  `),
          ...
          s(`: [
    {
      `),
          ...
          s(': '),
          a('span', { class: 'hljs-string' }, "'驳驳'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'isShowModal'),
          s(': '),
      ...
      `),
        ...
        `),
          ...
          s('('),
          a('span', { class: 'hljs-string' }, "'驳驳 onclick'"),
          s(`, val);
      }
    },
    {
      ...
      `),
          ...
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'modalTitle'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'自定义提示'"),
          s(`,
      `),
          a('span', { class: 'hljs-title function_' }, 'getModalContent'),
          s('('),
        ...
        `),
          ...
          s(),
          a('span', { class: 'hljs-string' }, "'自定义内容？'"),
          s(`
      },
      `),
          a('span', { class: 'hljs-keyword' }, 'async'),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'通过 onclick'"),
          s(`, val);
      }
    },
    {
      ...
      `),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'拒绝 onclick'"),
          s(`, val);
      }
    },
    {
      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'驳回驳回驳回'"),
          s(`,
      `),
          a('span', { class: 'hljs-keyword' }, 'async'),
          s(),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'驳回驳回驳回 onclick'"),
          s(`, val);
      }
    }
  ]
...
`),
          ...
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'钱'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age'),
          s(': '),
          a('span', { class: 'hljs-number' }, '2'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'西湖区湖底公园2号'"),
          s(`,
          },
          {
            `),
          ...
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'西湖区湖底公园3号'"),
          s(`,
          },
        ]
)
  ...
  `),
          ...
          s(`: [
    {
      ...
      `),
          ...
          a('span', { class: 'hljs-title function_' }, 'confirmAsync'),
          s('('),
          a('span', { class: 'hljs-params' }, 'record'),
          s(`) {
        `),
          a('span', { class: 'hljs-variable language_' }, 'console'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'驳驳 confirmAsync'"),
          s(`, record);
      },
      `),
          a('span', { class: 'hljs-title function_' }, 'getHidden'),
          s('('),
          a('span', { class: 'hljs-params' }, 'record'),
          s(`) {
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'驳驳 getHidden'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'if'),
          s(' (record.'),
          a('span', { class: 'hljs-property' }, 'age'),
          s(' === '),
          a('span', { class: 'hljs-number' }, '1'),
          s(`) {
            `),
      ...
      `),
          a('span', { class: 'hljs-title function_' }, 'getDisabled'),
          s('('),
          a('span', { class: 'hljs-params' }, 'record'),
          s(`) {
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'驳驳 getDisabled'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
    ...
    },
    {
      ...
      `),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'通过 getHidden'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
      ...
      `),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'通过 getDisabled'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'if'),
          s(' (record.'),
    ...
    },
    {
      ...
      `),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'拒绝 getHidden'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
      ...
      `),
        ...
        `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'拒绝 getDisabled'"),
          s(`, record);
        `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
...
`)
  ...
  K = a(
    ...
    [
      a('li', null, '最多展示两条，超过的内容会在下拉中展示'),
      a('li', null, '支持隐藏和禁止操作功能'),
      a('li', null, '没有选中时不允许操作')
    ],
    -1
  ),
  Q = a('h4', { id: '精简配置' }, '精简配置', -1),
  W = a(
    'pre',
    { class: 'language-xml' },
    [
...
`),
  ...
  `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-button'),
          s(' @'),
          a('span', { class: 'hljs-attr' }, 'click'),
          s('='),
          a('span', { class: 'hljs-string' }, '"handleOpenMul"'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"mb-8px"'),
          s('>')
        ]),
        s('开启多选'),
        a('span', { class: 'hljs-tag' }, [
  ...
  `),
        ...
        `),
         ...
         `),
          ...
          s(`
         @`),
          a('span', { class: 'hljs-attr' }, 'cancelMultiple'),
          s('='),
          a('span', { class: 'hljs-string' }, '"handleCancelMultiple"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          s(`({
    `),
          a('span', { class: 'hljs-attr' }, 'visible'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
    `),
          ...
          s(`: [
        {
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'操作'"),
          s(`,
            `),
          a('span', { class: 'hljs-comment' }, '// 点击回调'),
          s(`
            `),
          a('span', { class: 'hljs-keyword' }, 'async'),
          s(),
          ...
          a('span', { class: 'hljs-string' }, "'multiple'"),
          s(', '),
          a('span', { class: 'hljs-variable language_' }, 'arguments'),
          s(`);
              `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
...
`),
          ...
          s(),
          a('span', { class: 'hljs-title function_' }, 'handleOpenMul'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
    multiple.`),
          ...
          s('.'),
          a('span', { class: 'hljs-property' }, 'visible'),
          s(' = '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`
}
...
`),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'handleCancelMultiple'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
    multiple.`),
...
`),
    ...
    `),
          ...
          s(`: [
        {
          ...
          s(': '),
          a('span', { class: 'hljs-string' }, "'normal'"),
          s(`,
            `),
          a('span', { class: 'hljs-comment' }, '// 点击回调'),
          s(`
...
`)
  ...
  s0 = a('h3', { id: '分页配置' }, '分页配置', -1),
  a0 = a('ul', null, [a('li', null, '支持字段映射配置，方便不同后端定义的不同字段处理')], -1),
  n0 = a(
    'pre',
    { class: 'language-xml' },
    [
...
`),
  ...
  `),
        ...
        `),
          ...
          s(` 
        `),
          a('span', { class: 'hljs-attr' }, ':pagination'),
          s('='),
          a('span', { class: 'hljs-string' }, '"paginationRef"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':paginationMap'),
          s('='),
          a('span', { class: 'hljs-string' }, '"paginationMapRef"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'李'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age'),
          s(': '),
          a('span', { class: 'hljs-number' }, '4'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
...
`),
          ...
          s(`({
  `),
          a('span', { class: 'hljs-attr' }, 'currentMap'),
          s(': '),
          a('span', { class: 'hljs-number' }, '2'),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 当前页数'),
          s(`
  `),
          a('span', { class: 'hljs-attr' }, 'sizeMap'),
          s(': '),
          a('span', { class: 'hljs-number' }, '20'),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 每页数量'),
          s(`
  `),
          a('span', { class: 'hljs-attr' }, 'totalElements'),
          s(': '),
          a('span', { class: 'hljs-number' }, '1000'),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 总页数'),
          s(`
  `),
          a('span', { class: 'hljs-attr' }, 'currentFromNumber'),
          s(': '),
          a('span', { class: 'hljs-number' }, '0'),
          s(),
          a(
            'span',
            { class: 'hljs-comment' },
...
`),
          ...
          s(`({
  `),
          a('span', { class: 'hljs-attr' }, 'current'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'currentMap'"),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 当前页数'),
          s(`
  `),
          a('span', { class: 'hljs-attr' }, 'pageSize'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'sizeMap'"),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 每页数量'),
          s(`
  `),
          a('span', { class: 'hljs-attr' }, 'total'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'totalElements'"),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 总页数'),
          s(`
  `),
...
`)
  ...
  t0 = a(
    ...
    null,
    [
      a('li', null, '操作类型：用于操作，如打开弹窗等操作，为按钮效果'),
      a('li', null, '跳转类型：用于跳转，如改变路由，为link效果'),
      a('li', null, '切换类型：用于切换，如改变上架下架类型，为switch效果'),
      a(
        'li',
        null,
        '状态类型：用于状态展示，效果为文字前面有标识，目前支持 init、process、success、fail 四种状态'
      ),
      a('li', null, '预览或下载类型：用于资源文件的展示或下载')
    ],
    -1
  ),
  e0 = a('h4', { id: '精简配置-1' }, '精简配置', -1),
  c0 = a(
    'pre',
    { class: 'language-xml' },
    [
...
`),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'typeConfig'),
          s(`: {
              `),
          a('span', { class: 'hljs-attr' }, 'type'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'button'"),
          s(`,
              `),
          a('span', { class: 'hljs-title function_' }, 'click'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                `),
          a('span', { class: 'hljs-variable language_' }, 'console'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'onclick'"),
          s(`, bindValue)
              },
            }
          },
          ...
          a('span', { class: 'hljs-attr' }, 'type'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'switch'"),
          s(`,
              `),
          a('span', { class: 'hljs-title function_' }, 'getChecked'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
                `),
          ...
          s(`
              ...
              `),
          a('span', { class: 'hljs-comment' }, '// 点击确定'),
          s(`
              `),
          a('span', { class: 'hljs-keyword' }, 'async'),
          s(),
          ...
          },
         {
          ...
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'displacement'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'typeConfig'),
          s(`: {
          ...
          a('span', { class: 'hljs-attr' }, 'type'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'status'"),
          s(`,
              `),
          a('span', { class: 'hljs-title function_' }, 'getStatus'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`){
                  `),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'变速箱类型'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'gearboxName'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'typeConfig'),
          s(`: {
          ...
          a('span', { class: 'hljs-attr' }, 'type'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'previewDownload'"),
          s(`,
              `),
          a('span', { class: 'hljs-title function_' }, 'getUrl'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`){
                 `),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'能源类型'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'energyName'"),
          s(`,
           },
        ]
)
...
`),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'displacement'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1.0T'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'gearboxName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'自动'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'energyName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'燃油'"),
          s(`
          },
        ]
)
...
`),
          ...
          a('span', { class: 'hljs-keyword' }, 'if'),
          s(' (bindValue.'),
          a('span', { class: 'hljs-property' }, 'index'),
          s(' === '),
          a('span', { class: 'hljs-number' }, '1'),
          s(`) {
                    `),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'性别'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'sex'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'type'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'copy'"),
          s(`,
              `),
          a('span', { class: 'hljs-title function_' }, 'getEnable'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                `),
          ...
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'getEnable'"),
          s(`, bindValue)
                `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          ...
          s(`;
                ...
                `),
          a('span', { class: 'hljs-title function_' }, 'getLeftLabel'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                  `),
          ...
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          a('span', { class: 'hljs-string' }, "'下架'"),
          s(`;
                },
                `),
          a('span', { class: 'hljs-title function_' }, 'getRightLabel'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                  `),
          ...
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          a('span', { class: 'hljs-string' }, "'上架'"),
          s(`;
                },
                `),
          a('span', { class: 'hljs-title function_' }, 'getTitle'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                  `),
          ...
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          a('span', { class: 'hljs-string' }, "'确定操作switch？'"),
          s(`;
                },
                `),
          a('span', { class: 'hljs-title function_' }, 'getContent'),
          s('('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          s(`) {
                  `),
          ...
          },
         {
          ...
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          a('span', { class: 'hljs-string' }, "'process'"),
          s(`
                } `),
          a('span', { class: 'hljs-keyword' }, 'else'),
          s(),
          ...
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'getEnablePreview'),
          s(': '),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(' ('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          ...
          s(`
              ...
              `),
          a('span', { class: 'hljs-attr' }, 'getEnableDownload'),
          s(': '),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(' ('),
          a('span', { class: 'hljs-params' }, 'bindValue'),
          ...
          a('span', { class: 'hljs-keyword' }, 'async'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'downloadAsync'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
                `),
...
`),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'sex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'男'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'displacement'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1.5T'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'gearboxName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'手动'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'energyName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'纯电'"),
          s(`
          },
          {
            `),
          ...
          a('span', { class: 'hljs-attr' }, 'displacement'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'2.0T'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'gearboxName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'脚动'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'energyName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'混合'"),
          s(`
          },
          {
            `),
          ...
          a('span', { class: 'hljs-attr' }, 'displacement'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'2.5T'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'gearboxName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'混动'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'energyName'),
          s(': '),
...
`)
  ...
  p0 = a('h3', { id: 'antd功能' }, 'antd功能', -1),
  i0 = a('p', null, '除弃用属性，其余属性、事件、插槽均支持', -1),
  h0 = a(
    'pre',
    { class: 'language-xml' },
    [
    ...
    >`)
       ...
       `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-name' }, 'template'),
          s(' #'),
          a('span', { class: 'hljs-attr' }, 'headerCell'),
          s('='),
          a('span', { class: 'hljs-string' }, '"{ column, text }"'),
          s('>')
        ]),
        s(`
          `),
        a('span', { class: 'hljs-tag' }, [
          ...
          s('='),
          a('span', { class: 'hljs-string' }, `"column.dataIndex === 'name'"`),
          s('>')
        ]),
        s(`
            `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'span'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"color-red"'),
          s('>')
        ]),
        s(`
              插槽展示 {{ text }}
        ...
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-name' }, 'template'),
          s(' #'),
          a('span', { class: 'hljs-attr' }, 'bodyCell'),
          s('='),
          a('span', { class: 'hljs-string' }, '"{ column, text }"'),
          s('>')
        ]),
        ...
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'v-if'),
          s('='),
          a('span', { class: 'hljs-string' }, `"column.dataIndex === 'age1'"`),
          s('>')
        ]),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
...
`),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'filters'),
          s(`: [
              {
                `),
          a('span', { class: 'hljs-attr' }, 'text'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'赵山河'"),
          s(`,
                `),
          ...
          s(`,
            ...
            `),
          a('span', { class: 'hljs-attr' }, 'filterSearch'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'onFilter'),
          s(': '),
          a('span', { class: 'hljs-function' }, [
            s('('),
            a('span', { class: 'hljs-params' }, 'value, record'),
            s(') =>')
          ]),
          s(' record.'),
          a('span', { class: 'hljs-property' }, 'name'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'includes'),
          s(`(value)
          },
          {
            `),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'年龄1'"),
          s(`,
                    `),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'age1'"),
          s(`,
                    `),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'年龄2'"),
          s(`,
                    `),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'age2'"),
          s(`,
                    `),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'sorter'),
          s(': '),
          a('span', { class: 'hljs-function' }, [
            s('('),
            a('span', { class: 'hljs-params' }, 'a, b'),
            s(') =>')
          ]),
          s(' a.'),
          a('span', { class: 'hljs-property' }, 'age'),
...
`),
          ...
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age1'),
          s(': '),
          a('span', { class: 'hljs-number' }, '31'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age2'),
          s(': '),
          a('span', { class: 'hljs-number' }, '32'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'description'),
          s(': '),
          a(
            'span',
            { class: 'hljs-string' },
          ...
          a('span', { class: 'hljs-attr' }, 'age1'),
          s(': '),
          a('span', { class: 'hljs-number' }, '33'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age2'),
          s(': '),
          a('span', { class: 'hljs-number' }, '34'),
          s(`,
          },
          {
            `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'赵铁柱'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'西湖区湖底公园4号'"),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age1'),
          s(': '),
          a('span', { class: 'hljs-number' }, '35'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age2'),
          s(': '),
          a('span', { class: 'hljs-number' }, '36'),
          s(`,
          },
          {
            `),
          ...
          a('span', { class: 'hljs-attr' }, 'age1'),
          s(': '),
          a('span', { class: 'hljs-number' }, '37'),
          s(`,
            `),
          a('span', { class: 'hljs-attr' }, 'age2'),
          s(': '),
          a('span', { class: 'hljs-number' }, '38'),
          s(`,
          },
        ]
)

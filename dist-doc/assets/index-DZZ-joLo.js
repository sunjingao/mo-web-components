import { C as D } from './vue-BWiB27ne.js';
import {
  f,
  g as e,
  h as b,
  ...
  u as B,
  a as N
} from './index-DvUcxQWp.js';
/* empty css                                                            */ const V = f({
    __name: 'index.md.Virtual0860faaf',
    setup(u) {
      const l = e({}),
        p = e([
          { componentName: 'mInput', uploadKey: '1mInput', formItemProps: { label: 'mInput1' } }
        ]);
      return (
        b(
          l,
          () => {
            console.log('formRef.value', l.value);
          },
          { deep: !0 }
        ),
        (m, r) => {
  ...
  S = f({
    __name: 'index.md.Virtual380a735a',
    setup(u) {
      const l = e({}),
        p = e([
          {
          ...
          },
          {
            componentName: 'mInput',
            uploadKey: 'mInput2',
            formItemProps: { label: 'Input2', tooltip: 'label配置' }
          },
          {
            componentName: 'mInput',
            uploadKey: 'mInput3',
          ...
          { componentName: 'mInput', uploadKey: 'mInput4', formItemProps: { label: 'mInp4' } }
        ]),
        m = {
          mInput4: [
  ...
  T = f({
    __name: 'index.md.Virtualc42c7cfa',
    setup(u) {
      const l = e({}),
        p = e([
          {
          ...
          { componentName: 'mFormItemDes', uploadKey: 'val2', formItemProps: { label: 'mInput2' } },
          {
            componentName: 'mFormItemDes',
            uploadKey: 'val3',
            defaultValue: '123321',
  ...
  Y = { class: 'mb-8px flex items-center' },
  z = f({
    __name: 'index.md.Virtual71b145f7',
    setup(u) {
      const l = e({}),
        p = e(!1),
        m = e([
          ...
          { componentName: 'mInput', uploadKey: 'mInput2', formItemProps: { label: 'mInput2' } }
        ]);
      return (
        b(
          l,
            ...
            E(
              ...
              [
                a('div', Y, [
                  ...
                  n(
                    c,
                    { checked: p.value, 'onUpdate:checked': o[0] || (o[0] = (i) => (p.value = i)) },
                    null,
                    8,
                    ['checked']
                  ),
  ...
  M = { class: 'flex mb-8px' },
  U = f({
    __name: 'index.md.Virtual696c44cb',
    setup(u) {
      const l = e({}),
        p = e(!0),
        m = e(3),
        ...
        d = e([
          { componentName: 'mInput', uploadKey: '1mInput', formItemProps: { label: 'mInput1' } },
          { componentName: 'mInput', uploadKey: '2mInput', formItemProps: { label: 'mInput2' } },
          { componentName: 'mInput', uploadKey: '3mInput', formItemProps: { label: 'mInput3' } },
          { componentName: 'mInput', uploadKey: '4mInput', formItemProps: { label: 'mInp4' } },
          { componentName: 'mInput', uploadKey: '5mInput', formItemProps: { label: 'mInp5' } },
          { componentName: 'mInput', uploadKey: '6mInput', formItemProps: { label: 'mInp6' } }
        ]);
      function i() {
        r.value === 'horizontal' ? (p.value = !0) : (p.value = !1);
      }
      function y() {
        r.value === 'horizontal' && (c.value.span = 24 - o.value.span);
      }
      return (
        b(
          l,
          ...
          return (
            ...
            E('div', null, [
              a('div', M, [
                n(
                  C,
                  { value: m.value, 'onUpdate:value': j[0] || (j[0] = (v) => (m.value = v)) },
                  {
                    default: t(() => [
                      n(g, { value: 5 }, { default: t(() => [s('5列')]), _: 1 }),
                      n(g, { value: 4 }, { default: t(() => [s('4列')]), _: 1 }),
                      n(g, { value: 3 }, { default: t(() => [s('3列')]), _: 1 }),
                      n(g, { value: 2 }, { default: t(() => [s('2列')]), _: 1 }),
                      n(g, { value: 1 }, { default: t(() => [s('1列')]), _: 1 })
                    ]),
                    _: 1
                  },
                  8,
                ...
                n(
                  ...
                  {
                    value: r.value,
                    'onUpdate:value': j[1] || (j[1] = (v) => (r.value = v)),
                    class: 'ml-8px',
                    onChange: i
                  },
                  {
                    default: t(() => [
                      n(g, { value: 'horizontal' }, { default: t(() => [s('水平')]), _: 1 }),
                      n(g, { value: 'vertical' }, { default: t(() => [s('竖直')]), _: 1 })
                    ]),
                    _: 1
                  },
                  8,
                ...
                n(
                  ...
                  {
                    value: o.value.span,
                    'onUpdate:value': j[2] || (j[2] = (v) => (o.value.span = v)),
                    min: 1,
                    max: 23,
                    onChange: y,
                    class: 'w-100px'
                ...
                n(
                  ...
                  {
                    value: c.value.span,
                    'onUpdate:value': j[3] || (j[3] = (v) => (c.value.span = v)),
                    min: 1,
                    max: 23,
                    disabled: p.value,
              ...
              n(
                ...
                {
                  modelValue: l.value,
                  'onUpdate:modelValue': j[4] || (j[4] = (v) => (l.value = v)),
                  items: d.value,
                  columnsNumber: m.value,
                  layout: r.value,
                  labelCol: o.value,
                  wrapperCol: c.value
                },
                null,
                8,
                ['modelValue', 'items', 'columnsNumber', 'layout', 'labelCol', 'wrapperCol']
              )
            ])
          );
        }
  ...
  L = f({
    __name: 'index.md.Virtual5fe27108',
    setup(u) {
      const l = e({}),
        p = e([
          {
          ...
          { componentName: 'mCheckbox', uploadKey: '3mCheckbox', formItemProps: { label: '选择' } },
          {
            componentName: 'mCheckboxGroup',
            uploadKey: '4mCheckboxGroup',
            formItemProps: { label: '多选' },
            componentProps: {
              options: [
          ...
          },
          {
            ...
            componentProps: {
              options: [
                ...
                { label: 'Pear', value: 'Pear' },
                { label: 'Ora', value: 'Ora', disabled: !0 }
              ]
            }
          },
          { componentName: 'mRate', uploadKey: '9mRate', formItemProps: { label: 'mRate' } },
          {
          ...
          { componentName: 'mSlider', uploadKey: '11mSlider', formItemProps: { label: 'mSlider' } },
          { componentName: 'mSwitch', uploadKey: '12mSwitch', formItemProps: { label: 'mSwitch' } },
          {
            componentName: 'mTimePicker',
            uploadKey: '13mTimePicker',
            formItemProps: { label: '时间' }
          },
          {
  ...
  $ = f({
    __name: 'index.md.Virtual1862b0e5',
    setup(u) {
      const l = e({}),
        p = e([
          {
  ...
  G = f({
    props: { value: String, columns: Array, data: Array },
    setup(u, { emit: l }) {
      return { customSelf: K(u, 'value', l) };
    }
  }),
  O = a('span', null, '我是自定义组件', -1);
function J(u, l, p, m, r, o) {
  const c = h('m-input'),
    d = h('m-table');
  return (
    A(),
    E('div', null, [
      ...
      n(
        ...
        {
          value: u.customSelf,
          'onUpdate:value': l[0] || (l[0] = (i) => (u.customSelf = i)),
          class: 'mt-8px'
        },
        null,
        8,
      ...
      n(d, { class: 'mt-8px', columns: u.columns, dataSource: u.data, pagination: !1 }, null, 8, [
        'columns',
        'dataSource'
      ])
    ])
...
const q = x(G, [['render', J]]),
  H = f({
    __name: 'index.md.Virtual310ef933',
    setup(u) {
      const l = e({}),
        p = e([
          {
  ...
  Z = { class: 'mb-8px flex items-center' },
  Q = { key: 0 },
  W = { key: 1 },
  X = f({
    __name: 'index.md.Virtual34b5e8ea',
    setup(u) {
      const l = e(),
        p = e({}),
        m = e(!1),
          ...
          },
          {
            ...
            formItemProps: {
              ...
              rules: w(() =>
                m.value
                  ? null
                  : [{ required: !0, message: 'form-item设置的必填', trigger: 'change' }]
              )
            }
          }
        ]),
        o = w(() =>
          m.value
            ? null
            : { mInput1: [{ required: !0, message: 'form设置的必填', trigger: 'change' }] }
        ),
        c = e([
          {
            async confirmAsync() {
              await l.value.antFormComponent.validate(), console.log(111);
            },
            label: '通过',
            mode: 'success'
          }
      ...
      return (
        b(
          p,
          () => {
            console.log('formRef.value', p.value);
          },
          { deep: !0 }
        ),
        (d, i) => {
          ...
          return (
            ...
            E(
              ...
              null,
              [
                n(y, null, { default: t(() => [s('表单标题')]), _: 1 }),
                a('div', Z, [
                  s('展示'),
                  n(
                    _,
                    { checked: m.value, 'onUpdate:checked': i[0] || (i[0] = (C) => (m.value = C)) },
                    null,
                    8,
                    ['checked']
                  ),
                ...
                n(
                  j,
                  {
                    ...
                    ref: l,
                    modelValue: p.value,
                    'onUpdate:modelValue': i[1] || (i[1] = (C) => (p.value = C)),
                    items: r.value,
                    rules: o.value
                  },
                  {
                    prefix: t((C) => [
                      C.uploadKey === 'mInput1' ? (A(), E('div', Q, ' 1prefix插槽 ')) : P('', !0),
                      C.uploadKey === 'mInput2' ? (A(), E('div', W, ' 2prefix插槽 ')) : P('', !0)
                    ]),
                    _: 1
                  },
                  8,
                ...
                n(g, { items: c.value }, null, 8, ['items'])
              ],
              64
            )
          );
  ...
  ss = { class: 'marked-body' },
  as = N(
    '<h2 id="form表单">Form表单</h2><h3 id="简单使用">简单使用</h3><ul><li>label默认靠右对齐</li><li>label默认自动在结尾加冒号</li><li>在m-form标签上写的内容会直接传递给a-form</li><li>在m-form标签中的插槽会传递给数据录入的各个组件</li><li>items包含：</li><li><ul><li>绑定对象的配置；</li></ul></li><li><ul><li>formItemProps中的内容会传给a-form-item；</li></ul></li><li><ul><li>componentProps的内容会传递给组件；</li></ul></li></ul><h4 id="items精简配置">items精简配置</h4>',
    4
  ),
  ls = a(
    'pre',
    ...
    [
      a('code', { class: 'hljs' }, [
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'template'),
          s('>')
        ]),
        s(`
  `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-form'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, 'v-model'),
          s('='),
          a('span', { class: 'hljs-string' }, '"formRef"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':items'),
          s('='),
          a('span', { class: 'hljs-string' }, '"items"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'script'),
          s(),
          a('span', { class: 'hljs-attr' }, 'lang'),
          s('='),
          a('span', { class: 'hljs-string' }, '"ts"'),
          s(),
          a('span', { class: 'hljs-attr' }, 'setup'),
          s('>')
        ]),
        a('span', { class: 'language-javascript' }, [
          s(`
`),
          a('span', { class: 'hljs-keyword' }, 'import'),
          s(' {ref, watch} '),
          a('span', { class: 'hljs-keyword' }, 'from'),
          s(),
          a('span', { class: 'hljs-string' }, "'vue'"),
          s(`;

`),
          a('span', { class: 'hljs-keyword' }, 'const'),
          s(' formRef = '),
          a('span', { class: 'hljs-title function_' }, 'ref'),
          s(`({});
...
`),
  ...
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput1'"),
          s(` }
  }
]);

`),
          a('span', { class: 'hljs-title function_' }, 'watch'),
          s(`(
    formRef,
    `),
          a('span', { class: 'hljs-function' }, '() =>'),
          s(` {
      `),
          a('span', { class: 'hljs-variable language_' }, 'console'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-string' }, "'formRef.value'"),
          s(', formRef.'),
          a('span', { class: 'hljs-property' }, 'value'),
          s(`);
    },
    {
      `),
          a('span', { class: 'hljs-attr' }, 'deep'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`
    }
);
...
`)
  ...
  ns = a('h4', { id: 'items全部配置' }, 'items全部配置', -1),
  ts = a(
    'pre',
    { class: 'language-xml' },
    [
...
`),
  ...
  `),
        ...
        `),
          ...
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':rules'),
          s('='),
          a('span', { class: 'hljs-string' }, '"rules"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          s(`([
  {
    ...
    `),
          ...
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'设置的默认值'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput2'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: { 
        `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Input2'"),
          s(`,
        `),
          a('span', { class: 'hljs-attr' }, 'tooltip'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'label配置'"),
          s(`
    },
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput3'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
          ...
          s(` },
    `),
          a('span', { class: 'hljs-attr' }, 'componentProps'),
          s(': { '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput3'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'prefix'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'prefix'"),
          s(` },
  },
  {
    `),
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInput4'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: { 
        `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInp4'"),
          s(`
    },
  },
]);
...
`),
          ...
          s(` rules = {
        `),
          a('span', { class: 'hljs-attr' }, 'mInput4'),
          s(`: [
            { `),
          a('span', { class: 'hljs-attr' }, 'required'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'message'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'必填'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'trigger'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'change'"),
          s(` },
            { `),
          a('span', { class: 'hljs-attr' }, 'min'),
          s(': '),
          a('span', { class: 'hljs-number' }, '3'),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'max'),
          s(': '),
          a('span', { class: 'hljs-number' }, '5'),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'message'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Length should be 3 to 5'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'trigger'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'blur'"),
          s(` },
          ]
    }
...
`)
  ...
  es = a('h3', { id: '返显' }, '返显', -1),
  ps = a('ul', null, [a('li', null, '常用语详情页等展示')], -1),
  os = a('h4', { id: '配置' }, '配置', -1),
  rs = a(
    'pre',
    { class: 'language-xml' },
  ...
  `),
        ...
        `),
          ...
          s(`
        `),
          a('span', { class: 'hljs-attr' }, 'layout'),
          s('='),
          a('span', { class: 'hljs-string' }, '"vertical"'),
          s(`
  >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          s(`([
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mFormItemDes'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'val1'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'123321'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
...
`),
          a('span', { class: 'hljs-built_in' }, 'setTimeout'),
          s(`(
    `),
          a('span', { class: 'hljs-function' }, '() =>'),
          s(` {
...
`)
  ...
  cs = a('h3', { id: '隐藏功能' }, '隐藏功能', -1),
  ms = a('ul', null, [a('li', null, '支持某项根据条件进行隐藏')], -1),
  hs = a(
    'pre',
    { class: 'language-xml' },
    [
  ...
  `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-name' }, 'div'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"mb-8px flex items-center"'),
          s('>')
        ]),
        s('展示'),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-switch'),
          s(),
          a('span', { class: 'hljs-attr' }, 'v-model:checked'),
          s('='),
          a('span', { class: 'hljs-string' }, '"hidden"'),
          s(' />')
        ]),
        s('隐藏'),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          a('span', { class: 'hljs-title function_' }, 'ref'),
          s('('),
          a('span', { class: 'hljs-literal' }, 'false'),
          s(`)
...
`),
          ...
          s(`([
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'默认值'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'hidden'),
          s(`: hidden,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
...
`)
  ...
  As = a(
    ...
    null,
    [
      a('li', null, '支持1列、2列、3列（默认）'),
      a('li', null, 'label与组件支持水平（默认）和竖直两种'),
      a(
        'li',
        null,
...
`),
    ...
    `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"flex mb-8px"'),
          s('>')
        ]),
        s(`
        `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-select'),
          s(),
          a('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"columnsNumber"'),
          s('>')
        ]),
        s(`
            `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-select-option'),
          s(),
          a('span', { class: 'hljs-attr' }, ':value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"5"'),
          s('>')
        ]),
        s('5列'),
        a('span', { class: 'hljs-tag' }, [
        ...
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"layout"'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"ml-8px"'),
          s(' @'),
          a('span', { class: 'hljs-attr' }, 'change'),
          s('='),
          a('span', { class: 'hljs-string' }, '"handleSelect"'),
          s('>')
        ]),
        s(`
            `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"horizontal"'),
          s('>')
        ]),
        s('水平'),
        a('span', { class: 'hljs-tag' }, [
        ...
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-slider'),
          s(),
          a('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"labelCol.span"'),
          s(),
          a('span', { class: 'hljs-attr' }, ':min'),
          s('='),
          a('span', { class: 'hljs-string' }, '"1"'),
          ...
          a('span', { class: 'hljs-attr' }, ':max'),
          s('='),
          a('span', { class: 'hljs-string' }, '"23"'),
          s(' @'),
          a('span', { class: 'hljs-attr' }, 'change'),
          s('='),
          a('span', { class: 'hljs-string' }, '"handleLabelChange"'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"w-100px"'),
          s(' />')
        ]),
        s(`
        `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          a('span', { class: 'hljs-string' }, '"wrapperCol.span"'),
          s(),
          a('span', { class: 'hljs-attr' }, ':min'),
          s('='),
          a('span', { class: 'hljs-string' }, '"1"'),
          ...
          a('span', { class: 'hljs-string' }, '"23"'),
          s(),
          a('span', { class: 'hljs-attr' }, ':disabled'),
          s('='),
          a('span', { class: 'hljs-string' }, '"sliderDisabled"'),
          s(),
          a('span', { class: 'hljs-attr' }, 'class'),
          s('='),
          a('span', { class: 'hljs-string' }, '"w-100px ml-8px"'),
          s(' />')
        ]),
        s(`
    `),
  ...
  `),
        ...
        `),
          ...
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':columnsNumber'),
          s('='),
          a('span', { class: 'hljs-string' }, '"columnsNumber"'),
          s(`
        `),
          ...
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':labelCol'),
          s('='),
          a('span', { class: 'hljs-string' }, '"labelCol"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':wrapperCol'),
          s('='),
          a('span', { class: 'hljs-string' }, '"wrapperCol"'),
          s(`
    >`)
        ]),
        a('span', { class: 'hljs-tag' }, [
...
`),
          ...
          s(`({
    `),
          a('span', { class: 'hljs-attr' }, 'span'),
          s(': '),
          a('span', { class: 'hljs-number' }, '6'),
          s(`
})
`),
          a('span', { class: 'hljs-keyword' }, 'const'),
...
`),
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'2mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'3mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'4mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: { 
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'5mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: { 
        `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInp5'"),
          s(`,
    },
  },
    {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'6mInput'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: { 
        `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInp6'"),
          s(`,
    },
  },
]);
...
`),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'handleSelect'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
    `),
          a('span', { class: 'hljs-keyword' }, 'if'),
          s(' (layout.'),
          a('span', { class: 'hljs-property' }, 'value'),
          s(' === '),
          a('span', { class: 'hljs-string' }, "'horizontal'"),
          ...
          a('span', { class: 'hljs-keyword' }, 'else'),
          s(` {
            sliderDisabled.`),
          a('span', { class: 'hljs-property' }, 'value'),
          s(' = '),
...
`),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'handleLabelChange'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
    `),
          ...
          a('span', { class: 'hljs-property' }, 'value'),
          s('.'),
          a('span', { class: 'hljs-property' }, 'span'),
          s(' = '),
          a('span', { class: 'hljs-number' }, '24'),
          s(' - labelCol.'),
          a('span', { class: 'hljs-property' }, 'value'),
          s('.'),
          a('span', { class: 'hljs-property' }, 'span'),
...
`)
  ...
  js = a('h3', { id: '内置组件' }, '内置组件', -1),
  ds = a(
    'ul',
    null,
    [
      a('li', null, '支持ant-design-vue中数据录入部分的所有组件'),
      a('li', null, '支持preview-download组件'),
      a('li', null, '以上组件在form中做了以下集成，所以配置中不需要进行设置以下属性'),
      a('li', null, [
        a('ul', null, [
          a('li', null, 'v-model对应关系，如v-model:value或v-model:checked的value或者checked')
        ])
      ]),
      a('li', null, [a('ul', null, [a('li', null, '默认值')])])
    ],
    -1
  ),
  fs = a(
...
`),
          ...
          s(`([
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mCascader'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1mCascader'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
          ...
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'multiple'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'options'),
          s(`: [
        {
          `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhejiang'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Zhejiang'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'children'),
          s(`: [
            {
              `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'hangzhou'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Hangzhou'"),
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'xihu'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'West Lake'"),
          s(` }
              ]
            }
          ]
        },
        {
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'jiangsu'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Jiangsu'"),
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'nanjing'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Nanjing'"),
          ...
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'zhonghuamen'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Zhong Hua Men'"),
          s(` }
              ]
            }
          ]
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mDatePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'2mDatePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
          ...
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'format'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'YYYY/MM/DD'"),
          s(`
    }
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mCheckbox'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'3mCheckbox'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mCheckboxGroup'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'4mCheckboxGroup'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
      ...
      `),
        ...
        {`),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Apple'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'AppleValue'"),
          s(`},
        {`),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Pear'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Pear'"),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mRangePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'5mRangePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mInputNumber'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'7mInputNumber'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mRadioGroup'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'8mRadioGroup'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mRate'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'9mRate'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(': { '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mSelect'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'10mSelect'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(`: [],
    ...
    `),
          ...
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'mode'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'multiple'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'options'),
          s(`: [
        { `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'value1'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1'"),
        ...
        { `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'value2'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'2'"),
        ...
        { `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'value3'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'3'"),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mSlider'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'11mSlider'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mSwitch'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'12mSwitch'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mTimePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'13mTimePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mTimeRangePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'14mTimeRangePicker'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mTreeSelect'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'15mTreeSelect'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
          ...
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'treeData'),
          s(`: [
        {
          `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'root 1'"),
          s(`,
          `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 1'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 1-0'"),
          s(`,
                  `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'my leaf'"),
          s(`,
                      `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'leaf1'"),
          s(`
                    },
                    {
                      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'your leaf'"),
          s(`,
                      `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'leaf2'"),
          s(`
                    }
                  ]
                },
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 1-1'"),
          s(`,
                  `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 2'"),
          s(`,
              `),
          a('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mUpload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'16mUpload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
      ...
      {
        `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'1'"),
          s(`,
        `),
          a('span', { class: 'hljs-attr' }, 'url'),
          s(': '),
          a(
            'span',
            { class: 'hljs-string' },
    ...
    `),
          ...
          s(`: {
        `),
          a('span', { class: 'hljs-attr' }, 'uploadAsync'),
          s(': '),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
           `),
          a('span', { class: 'hljs-keyword' }, 'return'),
          s(),
          a('span', { class: 'hljs-title class_' }, 'Promise'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'resolve'),
          s(`({
                `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'测试1'"),
          s(`,
                `),
          a('span', { class: 'hljs-attr' }, 'url'),
          s(': '),
  ...
  },
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mPreviewDownload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'图片'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'18mPreviewDownload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'https://www.runoob.com/try/demo_source/horse.ogg'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'19mPreviewDownload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'https://www.runoob.com/try/demo_source/movie.mp4'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'20mPreviewDownload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'https://static.jyshare.com/download/sites.xlsx'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
  ...
  },
  {
    ...
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'21mPreviewDownload'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
...
`)
  ...
  gs = a('h3', { id: 'v-modelkey' }, 'v-model:key', -1),
  Cs = a(
    'ul',
    null,
    [
...
`),
  ...
  {
    `),
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 1'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'key'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'0-0'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'children'),
          s(`: [
      {
        ...
        `),
          a('span', { class: 'hljs-attr' }, 'key'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'0-0-0'"),
          s(`,
      },
      {
        `),
        ...
        `),
          a('span', { class: 'hljs-attr' }, 'key'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'0-0-1'"),
          s(`,
      },
      {
        `),
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'parent 1-2'"),
          s(`,
        `),
          a('span', { class: 'hljs-attr' }, 'key'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'0-0-2'"),
          s(`,
      },
    ],
  },
...
`),
          ...
          s(`([
 {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'mTree'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'menus'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
    ...
    `),
          ...
          s(`: [],
    `),
          a('span', { class: 'hljs-attr' }, 'vModelKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'checkedKeys'"),
          s(`,
    `),
          a('span', { class: 'hljs-attr' }, 'componentProps'),
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'checkable'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'treeData'),
          s(': '),
          a('span', { class: 'hljs-title function_' }, 'computed'),
          s('('),
          a('span', { class: 'hljs-function' }, '() =>'),
          s(` {
        `),
      ...
      `),
          a('span', { class: 'hljs-title function_' }, 'onCheck'),
          s('('),
          a('span', { class: 'hljs-params' }, 'val'),
          s(`) {
        formRef.`),
          a('span', { class: 'hljs-property' }, 'value'),
          s('.'),
          a('span', { class: 'hljs-property' }, 'menus'),
          s(` = val;
      }
    }
  }
...
`)
  ...
  Bs = a('h3', { id: '自定义组件' }, '自定义组件', -1),
  Es = a(
    'ul',
    null,
    [
      a('li', null, '当内置组件无法满足需求时，可以进行自定义组件的配置'),
      a('li', null, [a('ul', null, [a('li', null, '需要注册全局组件')])]),
      a('li', null, [a('ul', null, [a('li', null, 'componentProps中的参数会注入组件')])]),
      a('li', null, [
        a('ul', null, [
          a(
            'li',
...
`),
          ...
          a('span', { class: 'hljs-keyword' }, 'from'),
          s(),
          a('span', { class: 'hljs-string' }, "'./component/test/index.vue'"),
          s(`
...
`),
          ...
          s(`([
  {
    `),
          a('span', { class: 'hljs-attr' }, 'componentName'),
          s(': test, '),
          a('span', { class: 'hljs-comment' }, '// 全局注册的组件名称'),
          s(`
    `),
          a('span', { class: 'hljs-attr' }, 'uploadKey'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'custom'"),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// form表单中的key'),
          s(`
    `),
          a('span', { class: 'hljs-attr' }, 'defaultValue'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'123'"),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 默认值'),
          s(`
    `),
          a('span', { class: 'hljs-attr' }, 'formItemProps'),
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'自定义组件'"),
          s(`
    },
    `),
          a('span', { class: 'hljs-attr' }, 'componentProps'),
          s(`: {
      `),
          a('span', { class: 'hljs-attr' }, 'columns'),
          s(`: [
        { `),
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Name'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'name'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          a('span', { class: 'hljs-number' }, '200'),
          s(` },
        { `),
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Cash Assets'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'money'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'width'),
          s(': '),
          a('span', { class: 'hljs-number' }, '200'),
        ...
        { `),
          a('span', { class: 'hljs-attr' }, 'title'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Address'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'dataIndex'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'address'"),
      ...
      `),
          a('span', { class: 'hljs-attr' }, 'data'),
          s(`: [
        { `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'John Brown'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'money'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'￥300,000.00'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'New York No. 1 Lake Park'"),
          s(` },
        { `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Jim Green'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'money'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'￥1,256,000.00'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'London No. 1 Lake Park'"),
          s(` },
        { `),
          a('span', { class: 'hljs-attr' }, 'name'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Joe Black'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'money'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'￥120,000.00'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'address'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'Sidney No. 1 Lake Park'"),
          s(` }
      ]
    }
  },
...
`),
          a('span', { class: 'hljs-comment' }, '// <template>'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//   <div>'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     <span>我是自定义组件</span>'),
          s(`
`),
          a(
            'span',
...
`),
          ...
          s(`
`),
          a('span', { class: 'hljs-comment' }, '// '),
          s(`
`),
          a('span', { class: 'hljs-comment' }, "// import { defineComponent } from 'vue';"),
          s(`
`),
          a(
            'span',
...
`),
          ...
          s(`
`),
          a('span', { class: 'hljs-comment' }, '// export default defineComponent({'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//   props: {'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     value: String,'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     columns: Array,'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     data: Array'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//   },'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//   setup(props, { emit }) {'),
          s(`
`),
          a(
            'span',
...
`),
          ...
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     return {'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//       customSelf'),
          s(`
`),
          a('span', { class: 'hljs-comment' }, '//     };'),
          s(`
...
`)
  ...
  Is = a('h3', { id: 'antd功能' }, 'antd功能', -1),
  ys = a('p', null, '除弃用属性，其余属性、事件、插槽均支持', -1),
  ws = a(
    'pre',
    { class: 'language-xml' },
    [
  ...
  `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-title'),
          s('>')
        ]),
        s('表单标题'),
        a('span', { class: 'hljs-tag' }, [
  ...
  `),
        a('span', { class: 'hljs-tag' }, [
          ...
          s(`
        `),
          a('span', { class: 'hljs-attr' }, 'ref'),
          s('='),
          a('span', { class: 'hljs-string' }, '"formComRef"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, 'v-model'),
          s('='),
    ...
    >`)
        ...
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'prefix'),
          s('='),
          a('span', { class: 'hljs-string' }, '"bindValue"'),
          s('>')
        ]),
        s(`
           `),
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-name' }, 'div'),
          s(),
          a('span', { class: 'hljs-attr' }, 'v-if'),
          s('='),
          a('span', { class: 'hljs-string' }, `"bindValue.uploadKey === 'mInput1'"`),
          s('>')
        ]),
        s(`
             1prefix插槽
        ...
        a('span', { class: 'hljs-tag' }, [
          ...
          a('span', { class: 'hljs-attr' }, 'v-if'),
          s('='),
          a('span', { class: 'hljs-string' }, `"bindValue.uploadKey === 'mInput2'"`),
          s('>')
        ]),
        s(`
             2prefix插槽
    ...
    `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-footer'),
          s(),
          a('span', { class: 'hljs-attr' }, ':items'),
          s('='),
          a('span', { class: 'hljs-string' }, '"footerItems"'),
          s('>')
        ]),
        a('span', { class: 'hljs-tag' }, [
          s('</'),
...
`),
  ...
  },
  {
    ...
    `),
          ...
          s(`: {
        `),
          a('span', { class: 'hljs-attr' }, 'showCount'),
          s(':'),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
    }
  },
  {
    ...
    `),
        ...
        `),
          ...
          a('span', { class: 'hljs-property' }, 'value'),
          s(' ? '),
          a('span', { class: 'hljs-literal' }, 'null'),
          s(` : [
                            { `),
          a('span', { class: 'hljs-attr' }, 'required'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'message'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'form-item设置的必填'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'trigger'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'change'"),
...
`),
    ...
    `),
        ...
        `),
          ...
          s(` : {
            `),
          a('span', { class: 'hljs-attr' }, 'mInput1'),
          s(`: [
                { `),
          a('span', { class: 'hljs-attr' }, 'required'),
          s(': '),
          ...
          a('span', { class: 'hljs-attr' }, 'message'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'form设置的必填'"),
          s(', '),
          a('span', { class: 'hljs-attr' }, 'trigger'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'change'"),
...
`),
    ...
    {
      `),
          a('span', { class: 'hljs-keyword' }, 'async'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'confirmAsync'),
          s('('),
          a('span', { class: 'hljs-params' }),
          s(`) {
        `),
          a('span', { class: 'hljs-keyword' }, 'await'),
          s(' formComRef.'),
          a('span', { class: 'hljs-property' }, 'value'),
          s('.'),
          a('span', { class: 'hljs-property' }, 'antFormComponent'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'validate'),
          s(`()
        `),
          a('span', { class: 'hljs-variable language_' }, 'console'),
          s('.'),
          a('span', { class: 'hljs-title function_' }, 'log'),
          s('('),
          a('span', { class: 'hljs-number' }, '111'),
          s(`)
      },
      `),
          a('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'通过'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'mode'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'success'"),
          s(`,
    },
])

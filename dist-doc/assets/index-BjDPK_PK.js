...
/* empty css                                                            */ const C = m({
    __name: 'index.md.Virtualcb19f580',
    setup(d) {
      n(!1);
      const p = n([
          { value: 'jack', label: '中1' },
          { value: 'lucy', label: '式12' },
          { value: 'disabled', label: '美123' },
          { value: 'yiminghe', label: '学1234' }
        ]),
        a = n([]);
      return (
        g(a, (e) => {
          ...
          return (
            ...
            j('div', null, [
              t(
                ...
                {
                  value: a.value,
                  'onUpdate:value': c[0] || (c[0] = (r) => (a.value = r)),
                  style: { width: '100%' },
                  options: p.value
                },
                null,
  ...
  f = m({
    __name: 'index.md.Virtual177572a8',
    setup(d) {
      n(!1);
      const p = n([
          { value: 'jack', label: '中1' },
          { value: 'lucy', label: '中12' },
          { value: 'disabled', label: '中123' },
          { value: 'yiminghe', label: '中1234' }
        ]),
        a = n([]);
      return (
        g(a, (e) => {
  ...
  b = { class: 'marked-body' },
  D = l('h2', { id: 'select' }, 'Select', -1),
  B = l('h3', { id: '搜索功能' }, '搜索功能', -1),
  y = l('ul', null, [l('li', null, '单选时也会默认开启搜索功能')], -1),
  E = l(
    'pre',
    { class: 'language-xml' },
    [
      l('code', { class: 'hljs' }, [
        s(`
`),
        l('span', { class: 'hljs-tag' }, [
          s('<'),
          l('span', { class: 'hljs-name' }, 'template'),
          s('>')
        ]),
        s(`
  `),
    ...
    `),
        l('span', { class: 'hljs-tag' }, [
          s('<'),
          l('span', { class: 'hljs-name' }, 'm-select'),
          s(`
      `),
          l('span', { class: 'hljs-attr' }, 'v-model:value'),
          s('='),
          l('span', { class: 'hljs-string' }, '"selectedItems"'),
          s(`
      `),
          l('span', { class: 'hljs-attr' }, 'style'),
          s('='),
          l('span', { class: 'hljs-string' }, '"width: 100%"'),
          s(`
      `),
          l('span', { class: 'hljs-attr' }, ':options'),
          s('='),
          l('span', { class: 'hljs-string' }, '"ops"'),
          s(`
    >`)
        ]),
        s(`
...
`),
        l('span', { class: 'hljs-tag' }, [
          s('<'),
          l('span', { class: 'hljs-name' }, 'script'),
          s(),
          l('span', { class: 'hljs-attr' }, 'lang'),
          s('='),
          l('span', { class: 'hljs-string' }, '"ts"'),
          s(),
          l('span', { class: 'hljs-attr' }, 'setup'),
          s('>')
        ]),
        l('span', { class: 'language-javascript' }, [
          s(`
  `),
          l('span', { class: 'hljs-keyword' }, 'import'),
          s(' {ref, watch} '),
          l('span', { class: 'hljs-keyword' }, 'from'),
          s(),
          l('span', { class: 'hljs-string' }, "'vue'"),
          s(`

  `),
          l('span', { class: 'hljs-keyword' }, 'const'),
          s(' test = '),
          l('span', { class: 'hljs-title function_' }, 'ref'),
          s('('),
          l('span', { class: 'hljs-literal' }, 'false'),
          s(`)
  `),
          l('span', { class: 'hljs-keyword' }, 'const'),
          s(' ops = '),
    ...
    {
      `),
          l('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'jack'"),
          s(`,
      `),
          l('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'中1'"),
          s(`,
    },
    {
      `),
          l('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'lucy'"),
          s(`,
      `),
          l('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'式12'"),
          s(`,
    },
    {
      `),
          l('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'disabled'"),
          s(`,
      `),
          l('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'美123'"),
          s(`,
    },
    {
      `),
          l('span', { class: 'hljs-attr' }, 'value'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'yiminghe'"),
          s(`,
      `),
          l('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'学1234'"),
          s(`,
    },
  ]);
  `),
          l('span', { class: 'hljs-keyword' }, 'const'),
          s(` selectedItems = ref<string[]>([]);

  `),
          l('span', { class: 'hljs-title function_' }, 'watch'),
          s(`(
    selectedItems,
    `),
          l('span', { class: 'hljs-function' }, [
            l('span', { class: 'hljs-params' }, 'val'),
            s(' =>')
          ]),
          s(` {
      `),
          l('span', { class: 'hljs-variable language_' }, 'console'),
          s('.'),
          l('span', { class: 'hljs-title function_' }, 'log'),
          s(`(val)
    }
  )
`)
  ...
  w = l('h3', { id: '全选' }, '全选', -1),
  k = l('ul', null, [l('li', null, '多选时，自动开启全选功能')], -1),
  I = l(
    'pre',
    { class: 'language-xml' },
    [
  ...
  `),
    ...
    `),
      ...
      `),
          ...
          s(`
      `),
          l('span', { class: 'hljs-attr' }, 'mode'),
          s('='),
          l('span', { class: 'hljs-string' }, '"multiple"'),
          s(`
    >`)
        ]),
        s(`
  ...
  `),
    ...
    },
    {
      ...
      `),
          l('span', { class: 'hljs-attr' }, 'label'),
          s(': '),
          l('span', { class: 'hljs-string' }, "'中1234'"),
          s(`,
    },
  ]);
  `),
...
`)
  ...
  x = _(
    '<h3 id="注意">注意</h3><ul><li>如果option中的文字字段不是label，要手动传入filterOption，否则搜索不准确</li></ul><h3 id="props">Props</h3><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>可选值或函数参数</th><th>默认值</th><th>是否必填</th></tr></thead><tbody><tr><td>enableSelectAll</td><td>多选时，是否开启全选</td><td>Boolean</td><td>-</td><td>true</td><td>否</td></tr></tbody></table>',
    4
  ),
  S = {
    __name: 'index',

import{C as j}from"./vue-D-uhq510.js";import{f,g as c,h as w,o as m,c as u,b as o,e as a,r as y,w as r,u as g,a as F,d as s}from"./index-DCAlKB3m.js";/* empty css                                                            */const _=a("div",null,"fileType控制",-1),v=a("div",null,"customFileType控制",-1),E=f({__name:"index.md.Virtual7bb0e93d",setup(A){const n=c([{name:"测试1",url:"https://www.runoob.com/try/demo_source/pineapple.jpg"}]),l=c([{name:"测试1",url:"https://www.runoob.com/try/demo_source/pineapple.jpg"}]),d=c([{maxSize:5242880,errorTip:"图片大小不能大于5M，仅支持image/png, image/jpeg！",content:["image/png","image/jpeg"]},{maxSize:52,errorTip:"视频大小不能大于52kb，仅支持video/mp4！",content:["video/mp4"]}]);function i(h){return new Promise(t=>{setTimeout(()=>{t({name:"测试1",url:"https://www.runoob.com/try/demo_source/pineapple.jpg"})})})}return w(l,()=>{console.log("fileList2",l.value)},{deep:!0}),(h,t)=>{const e=y("m-upload");return m(),u("div",null,[_,o(e,{fileList:n.value,"onUpdate:fileList":t[0]||(t[0]=p=>n.value=p),fileType:["1"],uploadAsync:i},null,8,["fileList"]),v,o(e,{fileList:l.value,"onUpdate:fileList":t[1]||(t[1]=p=>l.value=p),customFileType:d.value,uploadAsync:i},null,8,["fileList","customFileType"])])}}}),B=f({__name:"index.md.Virtual5c099372",setup(A){const n=c([{name:"测试1",url:"https://www.runoob.com/try/demo_source/pineapple.jpg"}]),l=c({showPreviewIcon:!0,showRemoveIcon:!0,showDownloadIcon:!0});function d(){return console.log("deleteFileAsync",arguments),Promise.resolve()}async function i(){console.log("downloadAsync",arguments)}function h(t){return new Promise(e=>{setTimeout(()=>{e({name:"测试1",url:"https://www.runoob.com/try/demo_source/pineapple.jpg"})})})}return w(n,()=>{console.log("fileList",n.value)},{deep:!0}),(t,e)=>{const p=y("m-upload");return m(),u("div",null,[o(p,{fileList:n.value,"onUpdate:fileList":e[0]||(e[0]=b=>n.value=b),uploadAsync:h,showUploadList:l.value,deleteFileAsync:d,downloadAsync:i},null,8,["fileList","showUploadList"])])}}}),C={class:"marked-body"},D=F('<h2 id="upload">Upload</h2><h3 id="类型及尺寸">类型及尺寸</h3><ul><li>fileType支持的类型及尺寸</li></ul><blockquote><p>1：图片<br>const IMG = {<br> maxSize: 5242880, // 5m<br> errorTip: &#39;图片大小不能大于5M；仅支持image/png、image/jpeg格式！&#39;,<br> content: [&#39;image/png&#39;, &#39;image/jpeg&#39;]<br>};<br>2：文档<br>const DOC = {<br> maxSize: 52428800, // 50m<br> errorTip: &#39;文档大小不能大于50M；仅支持msword、document、excel、sheet、powerpoint、pdf格式！<br> content: [<br> &#39;application/msword&#39;,<br> &#39;application/vnd.openxmlformats-officedocument.wordprocessingml.document&#39;,<br> &#39;application/vnd.ms-excel&#39;,<br> &#39;application/vnd.openxmlformats-officedocument.spreadsheetml.sheet&#39;,<br> &#39;application/vnd.ms-powerpoint&#39;,<br> &#39;application/vnd.openxmlformats-officedocument.presentationml.presentation&#39;,<br> &#39;application/pdf&#39;<br> ]<br>};<br>3：视频<br>const VIDEO = {<br> maxSize: 157286400, // 150m<br> errorTip: &#39;视频大小不能大于150M；仅支持mp4格式！<br> content: [&#39;video/mp4&#39;]<br>};<br>4：压缩包<br>const PACK = {<br> maxSize: 209715200, // 200m<br> errorTip: &#39;资源文件大小不能大于500M；仅支持zip、rar、7z、tar、gzip格式！<br> content: [<br> &#39;application/x-zip-compressed&#39;,<br> &#39;application/x-rar-compressed&#39;,<br> &#39;application/zip&#39;,<br> &#39;application/x-7z-compressed&#39;,<br> &#39;application/vnd.ms-cab-compressed&#39;,<br> &#39;application/x-unix-archive&#39;,<br> &#39;application/x-tar&#39;,<br> &#39;application/gzip&#39;<br> ]<br>};</p></blockquote><ul><li>如果需要定制化组件接收的类型，需要设置customFileType字段，fileType字段失效</li></ul>',5),L=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-keyword"},"function"),s(),a("span",{class:"hljs-title function_"},"uploadAsync"),s("("),a("span",{class:"hljs-params"},"option"),s(`) {

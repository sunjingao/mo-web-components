import{C as A}from"./vue-CM8issi8.js";import{f as m,g as t,h as g,o as i,c as j,d as n,r as v,w as h,u,b as l,a as _,e as s}from"./index-3hIf_dzm.js";/* empty css                                                            */const C=m({__name:"index.md.Virtualcb19f580",setup(d){t(!1);const p=t([{value:"jack",label:"中1"},{value:"lucy",label:"式12"},{value:"disabled",label:"美123"},{value:"yiminghe",label:"学1234"}]),a=t([]);return g(a,e=>{console.log(e)}),(e,c)=>{const o=v("m-select");return i(),j("div",null,[n(o,{value:a.value,"onUpdate:value":c[0]||(c[0]=r=>a.value=r),style:{width:"100%"},options:p.value},null,8,["value","options"])])}}}),f=m({__name:"index.md.Virtual177572a8",setup(d){t(!1);const p=t([{value:"jack",label:"中1"},{value:"lucy",label:"中12"},{value:"disabled",label:"中123"},{value:"yiminghe",label:"中1234"}]),a=t([]);return g(a,e=>{console.log(e)}),(e,c)=>{const o=v("m-select");return i(),j("div",null,[n(o,{value:a.value,"onUpdate:value":c[0]||(c[0]=r=>a.value=r),style:{width:"100%"},options:p.value,mode:"multiple"},null,8,["value","options"])])}}}),D={class:"marked-body"},b=l("h2",{id:"select"},"Select",-1),B=l("h3",{id:"搜索功能"},"搜索功能",-1),y=l("ul",null,[l("li",null,"单选时也会默认开启搜索功能，"),l("li",null,"搜索时，支持拼音搜索中文，")],-1),E=l("pre",{class:"language-xml"},[l("code",{class:"hljs"},[s(`

...
/* empty css                                                            */ const _ = a(
  ...
  v = a('div', null, 'customFileType控制', -1),
  E = f({
    __name: 'index.md.Virtual6e3aef37',
    setup(A) {
      const t = c([{ name: '测试1', url: 'https://www.runoob.com/try/demo_source/pineapple.jpg' }]),
        l = c([{ name: '测试1', url: 'https://www.runoob.com/try/demo_source/pineapple.jpg' }]),
        d = c([
          {
            maxSize: 5242880,
      ...
      function i(h) {
        return new Promise((n) => {
          setTimeout(() => {
            n({ name: '测试1', url: 'https://www.runoob.com/try/demo_source/pineapple.jpg' });
          });
        });
      }
      return (
          ...
          return (
            ...
            u('div', null, [
              ...
              o(
                ...
                {
                  fileList: t.value,
                  'onUpdate:fileList': n[0] || (n[0] = (p) => (t.value = p)),
                  fileType: ['1'],
                  uploadAsync: i
                },
                null,
              ...
              o(
                ...
                {
                  fileList: l.value,
                  'onUpdate:fileList': n[1] || (n[1] = (p) => (l.value = p)),
                  customFileType: d.value,
                  uploadAsync: i
                },
                null,
                8,
                ['fileList', 'customFileType']
              )
            ])
          );
        }
  ...
  B = f({
    __name: 'index.md.Virtualbe5fdb96',
    setup(A) {
      const t = c([{ name: '测试1', url: 'https://www.runoob.com/try/demo_source/pineapple.jpg' }]),
        l = c({ showPreviewIcon: !0, showRemoveIcon: !0, showDownloadIcon: !0 });
      function d() {
        return console.log('deleteFileAsync', arguments), Promise.resolve();
      }
      async function i() {
      ...
      function h(n) {
        return new Promise((e) => {
          setTimeout(() => {
            e({ name: '测试1', url: 'https://www.runoob.com/try/demo_source/pineapple.jpg' });
          });
        });
      }
      return (
          ...
          return (
            ...
            u('div', null, [
              o(
                ...
                {
                  fileList: t.value,
                  'onUpdate:fileList': e[0] || (e[0] = (b) => (t.value = b)),
                  uploadAsync: h,
                  showUploadList: l.value,
                  deleteFileAsync: d,
                  downloadAsync: i
                },
                null,
  ...
  `),
    ...
    `),
     ...
     `),
        a('span', { class: 'hljs-tag' }, [
          s('<'),
          a('span', { class: 'hljs-name' }, 'm-upload'),
          s(` 
        `),
          a('span', { class: 'hljs-attr' }, 'v-model:fileList'),
          s('='),
          a('span', { class: 'hljs-string' }, '"fileList1"'),
          s(`
         `),
          a('span', { class: 'hljs-attr' }, ':fileType'),
          s('='),
         ...
         `),
          ...
          s('='),
          a('span', { class: 'hljs-string' }, '"uploadAsync"'),
          s(`
     >`)
        ]),
        s(`
     ...
     `),
        ...
        `),
          a('span', { class: 'hljs-attr' }, 'v-model:fileList'),
          s('='),
          a('span', { class: 'hljs-string' }, '"fileList2"'),
          s(` 
        `),
          a('span', { class: 'hljs-attr' }, ':customFileType'),
          s('='),
          a('span', { class: 'hljs-string' }, '"customFileType"'),
          s(` 
        `),
          a('span', { class: 'hljs-attr' }, ':uploadAsync'),
          s('='),
...
`),
    ...
    {
      `),
          a('span', { class: 'hljs-attr' }, 'maxSize'),
          s(': '),
          a('span', { class: 'hljs-number' }, '5242880'),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 5m'),
          s(`
      `),
          a('span', { class: 'hljs-attr' }, 'errorTip'),
          s(': '),
          a(
            'span',
            { class: 'hljs-string' },
            "'图片大小不能大于5M，仅支持image/png, image/jpeg！'"
          ),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'content'),
          s(': ['),
          a('span', { class: 'hljs-string' }, "'image/png'"),
          s(', '),
          a('span', { class: 'hljs-string' }, "'image/jpeg'"),
          s(`]
    },
    {
      `),
          a('span', { class: 'hljs-attr' }, 'maxSize'),
          s(': '),
          a('span', { class: 'hljs-number' }, '52'),
          s(', '),
          a('span', { class: 'hljs-comment' }, '// 52kb'),
          s(`
      `),
          a('span', { class: 'hljs-attr' }, 'errorTip'),
          s(': '),
          a('span', { class: 'hljs-string' }, "'视频大小不能大于52kb，仅支持video/mp4！'"),
          s(`,
      `),
          a('span', { class: 'hljs-attr' }, 'content'),
          s(': ['),
          a('span', { class: 'hljs-string' }, "'video/mp4'"),
          s(`]
    }
])
...
`),
          ...
          s(),
          a('span', { class: 'hljs-title function_' }, 'uploadAsync'),
          s('('),
          a('span', { class: 'hljs-params' }, 'formData'),
          s(`) {
    `),
        ...
        `),
          a('span', { class: 'hljs-function' }, [
            a('span', { class: 'hljs-params' }, 'resolve'),
            s(' =>')
          ]),
          s(` {
            `),
...
`)
  ...
  T = a('h3', { id: '删除及下载' }, '删除及下载', -1),
  x = a(
    'ul',
    null,
    [
      a('li', null, '删除会触发deleteFileAsync异步函数'),
      a('li', null, '下载会触发downloadAsync异步函数')
    ],
    -1
  ),
  k = a(
  ...
  `),
     ...
     `),
        ...
        `),
          a('span', { class: 'hljs-attr' }, 'v-model:fileList'),
          s('='),
          a('span', { class: 'hljs-string' }, '"fileList"'),
          s(`
        `),
          a('span', { class: 'hljs-attr' }, ':uploadAsync'),
          s('='),
          ...
          s(`
         `),
          a('span', { class: 'hljs-attr' }, ':showUploadList'),
          s('='),
          a('span', { class: 'hljs-string' }, '"showUploadList"'),
          s(`
         `),
          a('span', { class: 'hljs-attr' }, ':deleteFileAsync'),
          s('='),
          a('span', { class: 'hljs-string' }, '"deleteFileAsync"'),
          s(`
         `),
...
`),
          ...
          s(`({
        `),
          a('span', { class: 'hljs-attr' }, 'showPreviewIcon'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
        `),
          a('span', { class: 'hljs-attr' }, 'showRemoveIcon'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`,
        `),
          a('span', { class: 'hljs-attr' }, 'showDownloadIcon'),
          s(': '),
          a('span', { class: 'hljs-literal' }, 'true'),
          s(`
})
...
`),
          a('span', { class: 'hljs-keyword' }, 'function'),
          s(),
          a('span', { class: 'hljs-title function_' }, 'deleteFileAsync'),
          s('('),
